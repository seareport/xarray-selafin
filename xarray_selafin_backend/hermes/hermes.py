...
class HermesFile():
    ...
    def __init__(self, file_name, fformat,
        ...
        try:
            self.logger.debug("Loading Hermes extension module")
            import _hermes
        except Exception as execpt:
            from importlib import machinery
            raise Exception(
                f'{str(execpt)}\n'
                'Error: unable to load the extension module '
                f'_hermes{machinery.EXTENSION_SUFFIXES[0]}\n'
    ...
    def error(self, value):
        ...
        if value != 0:
            ...
            raise Exception("Hermes API error:\n{}".format(
